        ...
        'parameters': {
            ...
            'properties': {
                'kyc_delta': {
                    'type': 'object',
                    'description': (
                        'Le delta KYC complet avec internal_records et un bloc '
                        'analysis contenant new_information, opportunities et crm_alert.'
                    ),
        ...
        'parameters': {
            ...
            'properties': {
                ...
                'knowledge_base': {
                    'type': 'object',
                    'description': (
                        'Base de connaissance optionnelle des possibilités et limites de la banque. '
                        'Ses éléments doivent être considérés comme des pistes à qualifier.'
                    ),
                    'additionalProperties': True,
                },
            },
...
def _validate_kyc_delta(arguments: Dict[str, Any]) -> None:
    ...
    if not isinstance(analysis.get('new_information'), list):
